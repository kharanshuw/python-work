...
class DefaultDialect(interfaces.Dialect):
    ...
    def do_begin(self, dbapi_connection: interfaces.TypingDBAPIConnection) -> None: ...
    def do_rollback(
        self, dbapi_connection: interfaces.TypingDBAPIConnection
    ) -> None: ...
    def do_commit(self, dbapi_connection: interfaces.TypingDBAPIConnection) -> None: ...
    def do_close(self, dbapi_connection: interfaces.TypingDBAPIConnection) -> None: ...
    def do_ping(self, dbapi_connection: interfaces.TypingDBAPIConnection) -> bool: ...
    ...
    def do_release_savepoint(self, connection: base.Connection, name: str) -> None: ...
    def do_executemany(
        self,
...
class DefaultExecutionContext(interfaces.ExecutionContext):
    ...
    def get_out_parameter_values(self, names: Sequence[str]) -> Sequence[Any]: ...
