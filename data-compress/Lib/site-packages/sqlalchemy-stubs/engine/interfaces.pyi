...
class _DBAPICursorBase(Protocol):
    ...
    def executemany(self, operation: Any, parameters: Sequence[Any]) -> Any: ...
...
class Dialect:
    ...
    def do_prepare_twophase(self, connection: Connection, xid: str) -> None: ...
    ...
    def set_isolation_level(self, dbapi_conn: _DBAPIConnection, level: Any) -> None: ...
    def get_isolation_level(self, dbapi_conn: _DBAPIConnection) -> Any: ...
    def get_default_isolation_level(self, dbapi_conn: _DBAPIConnection) -> Any: ...
    @classmethod
...
class CreateEnginePlugin:
    ...
    def handle_pool_kwargs(self, pool_cls: Any, pool_args: Dict[str, Any]) -> None: ...
...
class ExecutionContext:
    ...
    def get_result_cursor_strategy(self, result: Any) -> CursorFetchStrategy: ...
...
class Connectable:
    ...
    def scalar(self, object_: Any, *multiparams: Any, **params: Any) -> Any: ...
