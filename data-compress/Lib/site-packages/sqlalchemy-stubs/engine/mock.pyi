...
class MockConnection(base.Connectable):
    ...
    def execution_options(self: _TMockConnection, **opt: Any) -> _TMockConnection: ...
    def compiler(self, statement: Any, parameters: Any, **kwargs: Any) -> Compiled: ...
    def create(self, entity: Any, **kwargs: Any) -> None: ...
    def drop(self, entity: Any, **kwargs: Any) -> None: ...
    def execute(self, object_: Any, *multiparams: Any, **params: Any) -> NoReturn: ...

def create_mock_engine(url: Any, executor: Any, **kw: Any) -> MockConnection: ...
