...
class _ConnectionCallable(Protocol[_T_contra, _T_co]):
    def __call__(self, __connection: _T_contra, *args: Any, **kwargs: Any) -> _T_co: ...
...
class Connection(_ConnectionTypingCommon, Connectable):
    ...
    def begin_twophase(self, xid: Optional[str] = ...) -> TwoPhaseTransaction: ...
...
class Engine(_EngineTypingCommon, Connectable, log.Identified):
    ...
    def has_table(self, table_name: str, schema: Optional[str] = ...) -> bool: ...
    def raw_connection(
...
class OptionEngineMixin:
    ...
    dispatch: Any = ...
    pool: Pool = ...
    def __init__(self, proxied: Engine, execution_options: _ExecuteOptions) -> None: ...
