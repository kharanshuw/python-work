...
class Result(_WithKeys, ResultInternal):
    ...
    def unique(self: _TResult, strategy: Optional[object] = ...) -> _TResult: ...
...
class MappingResult(_WithKeys, FilterResult):
    ...
    def columns(self: _TMappingResult, *col_expressions: object) -> _TMappingResult: ...
    def partitions(
    ...
    def fetchmany(self, size: Optional[int] = ...) -> List[Mapping[Any, Any]]: ...
...
class FrozenResult:
    ...
    def with_new_rows(self, tuple_data: List[Tuple[Any, ...]]) -> FrozenResult: ...
...
class MergedResult(IteratorResult):
    closed: bool = ...
    def __init__(self, cursor_metadata: ResultMetaData, results: Result) -> None: ...
    def close(self) -> None: ...
