...
class Query(
    ...
    def with_session(self: _TQuery, session: Optional[_SessionProtocol]) -> _TQuery: ...
    ...
    def join(self: _TQuery, target: Any, *props: Any, **kwargs: Any) -> _TQuery: ...
    def outerjoin(
    ...
    def instances(self, result_proxy: Any, context: Optional[Any] = ...) -> Any: ...
...
class FromStatement(GroupedElement, SelectBase, Executable):
    ...
    def get_label_style(self) -> _symbol: ...
    def set_label_style(self, label_style: _symbol) -> SelectStatementGrouping: ...
...
class BulkUpdate(BulkUD):
    values: Any = ...
    update_kwargs: Any = ...
    def __init__(self, query: Query[Any], values: Any, update_kwargs: Any) -> None: ...
