...
_TSessionTransaction = TypeVar("_TSessionTransaction", bound=SessionTransaction)
...
class _SessionProtocol(_SharedSessionProtocol[Union[Connection, Engine]], Protocol):
    ...
    def refresh(
        ...
        with_for_update: Optional[Union[Literal[True], Mapping[str, Any]]] = ...,
    ) -> None: ...
...
class _SessionTypingCommon(_SessionNoIoTypingCommon[Union[Connection, Engine]]):
...
class Session(
    ...
    def __init__(
        ...
        query_cls: Optional[Union[Type[Query[Any]], Callable[..., Query[Any]]]] = ...,
    ) -> None: ...
...
class sessionmaker(_SessionClassMethods, Generic[_TSessionMakerType]):
    ...
    if sys.version_info >= (3, 0):
        ...
        def __init__(
            self,
            bind: Optional[Union[Connection, Engine, AsyncConnection, AsyncEngine]],
            class_: Type[_TSessionMakerType],
            autoflush: bool = ...,
            autocommit: bool = ...,  # NOTE: Deprecated.
            expire_on_commit: bool = ...,
