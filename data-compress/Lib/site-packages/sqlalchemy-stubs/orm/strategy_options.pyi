...
class Load(Generative, LoaderOption):
    ...
    def contains_eager(loadopt: _L, attr: Any, alias: Optional[Any] = ...) -> _L: ...
    def load_only(loadopt: _L, *attrs: Any) -> _L: ...
    def joinedload(loadopt: _L, attr: Any, innerjoin: Optional[bool] = ...) -> _L: ...
...
class _containseager_loader_option(loader_option):
    ...
    def _unbound_fn(self, attr: Any, alias: Optional[Any] = ...) -> _UnboundLoad: ...
...
class _joinedload_loader_option(loader_option):
    def fn(self, loadopt: _L, attr: Any, innerjoin: Optional[bool] = ...) -> _L: ...
    def _unbound_fn(
