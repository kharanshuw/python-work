...
_TAsyncMappingResult = TypeVar("_TAsyncMappingResult", bound=AsyncMappingResult)
...
class AsyncResult(AsyncCommon):
    ...
    def unique(self: _TAsyncResult, strategy: Optional[Any] = ...) -> _TAsyncResult: ...
    def columns(self: _TAsyncResult, *col_expressions: Any) -> _TAsyncResult: ...
...
class AsyncMappingResult(AsyncCommon):
    ...
    async def fetchmany(self, size: Optional[int] = ...) -> List[Mapping[Any, Any]]: ...
