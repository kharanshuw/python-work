...
_TAsyncSessionProtocol = TypeVar("_TAsyncSessionProtocol", bound=_AsyncSessionProtocol)
...
class _AsyncSessionProtocol(
    ...
    async def flush(self, objects: Optional[Collection[Any]] = ...) -> None: ...
    @classmethod
...
class AsyncSession(
    ...
    def __init__(
        ...
        binds: Optional[Mapping[object, Union[AsyncConnection, AsyncEngine]]] = ...,
        sync_session_class: Type[Session] = ...,
        **kw: Any,
    ) -> None: ...
    async def run_sync(self, fn: Callable[..., _M], *arg: Any, **kw: Any) -> _M: ...
    async def stream(
        self,
        statement: Any,
        params: Optional[_ExecuteParams] = ...,
