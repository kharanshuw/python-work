...
def get_cls_kwargs(cls: Type[Any], _set: Optional[Set[str]] = ...) -> Set[str]: ...
...
class classproperty(property, Generic[_T]):
    __doc__: Optional[str] = ...
    def __init__(self, fget: Callable[[Any], _T], *arg: Any, **kw: Any) -> None: ...
...
def warn_exception(func: Callable[..., _T], *args: Any, **kwargs: Any) -> _T: ...
def ellipses_string(value: compat.text_type, len_: int = ...) -> compat.text_type: ...
