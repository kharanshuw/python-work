...
class IdentitySet(Generic[_T]):
    ...
    def __sub__(self: _IS, other: Iterable[_T]) -> Union[_NotImplementedType, _IS]: ...
    def difference_update(self, iterable: Iterable[_T]) -> None: ...
    def __isub__(self: _IS, other: Iterable[_T]) -> Union[_NotImplementedType, _IS]: ...
    def intersection(self, iterable: Iterable[_U]) -> IdentitySet[Union[_T, _U]]: ...
    def __and__(
    ...
    def symmetric_difference_update(self: _IS, iterable: Iterable[_T]) -> None: ...
...
class UniqueAppender(Generic[_T]):
    ...
    @overload
    def __init__(self, data: Union[_DataAppender[_T], _DataAdder[_T]]) -> None: ...
    def append(self, item: _T) -> None: ...
    def __iter__(self) -> Iterator[_T]: ...
...
def update_copy(
    d: Dict[_KT, _VT],
    _new: Optional[Union[Mapping[_NKT, _NVT], Iterable[Tuple[_NKT, _NVT]]]] = ...,
    **kw: _VT,
