...
class ClauseElement(
    ...
    is_selectable: bool = ...
    def unique_params(self: _CLE, *optionaldict: Any, **kwargs: Any) -> _CLE: ...
    def params(self: _CLE, *optionaldict: Any, **kwargs: Any) -> _CLE: ...
    def compare(self, other: Any, **kw: Any) -> bool: ...
    def get_children(self, omit_attrs: Any = ..., **kw: Any) -> Iterable[Any]: ...
...
class ColumnElement(
    ...
    def operate(self, op: Any, *other: Any, **kwargs: Any) -> ClauseElement: ...
    def reverse_operate(self, op: Any, other: Any, **kwargs: Any) -> ClauseElement: ...
    @property
    ...
    def cast(self: _COLE, type_: Union[Type[_OTE], _OTE]) -> Cast[_OTE, _COLE]: ...
...
class TextClause(
    ...
    __visit_name__: str = ...
    def __and__(self: _TC, other: _CLE) -> BooleanClauseList[Union[_TC, _CLE]]: ...
    key: Any = ...
    text: Any = ...
...
@overload
def literal_column(text: str, type_: None = ...) -> ColumnClause[sqltypes.NullType]: ...
@overload
def literal_column(text: str, type_: Union[_TE, Type[_TE]]) -> ColumnClause[_TE]: ...
...
class Cast(WrapsColumnExpression[_CLE], ColumnElement[_TE], Generic[_TE, _CLE]):  # type: ignore[misc]
    ...
    def __init__(self, expression: _CLE, type_: Union[_TE, Type[_TE]]) -> None: ...
    @property
    def wrapped_column_expression(self) -> _CLE: ...
...
class UnaryExpression(ColumnElement[_TE]):
    ...
    @classmethod
    def _create_nulls_first(cls, column: Any) -> UnaryExpression[sqltypes.NullType]: ...
    @classmethod
    def _create_nulls_last(cls, column: Any) -> UnaryExpression[sqltypes.NullType]: ...
    @classmethod
    def _create_desc(cls, column: Any) -> UnaryExpression[sqltypes.NullType]: ...
    @classmethod
    def _create_asc(cls, column: Any) -> UnaryExpression[sqltypes.NullType]: ...
    @classmethod
...
class CollectionAggregate(UnaryExpression[_TE]):
    @classmethod
    def _create_any(cls, expr: Any) -> CollectionAggregate[sqltypes.NullType]: ...
    @classmethod
    def _create_all(cls, expr: Any) -> CollectionAggregate[sqltypes.NullType]: ...
    def operate(self, op: Any, *other: Any, **kwargs: Any) -> ClauseElement: ...
...
class Grouping(GroupedElement, ColumnElement[_TE]):  # type: ignore[misc]
    ...
    @overload
    def __init__(self: Grouping[sqltypes.NullType], element: ClauseElement) -> None: ...
...
class Over(ColumnElement[_TE]):
    ...
    def __init__(
        ...
        partition_by: Optional[Union[_OverByType, Sequence[_OverByType]]] = ...,
...
class _truncated_label(quoted_name):
    def __new__(cls: Type[_QN], value: Any, quote: Optional[Any] = ...) -> _QN: ...
    def __reduce__(self) -> Any: ...
