...
class DDLElement(roles.DDLRole, Executable, _DDLCompiles):
    ...
    def execute_if(
        self: _DDLE,
        dialect: Optional[Union[str, Tuple[str, ...], List[str], Set[str]]] = ...,
        callable_: Optional[_DDLElementCallback] = ...,
        state: Optional[Any] = ...,
    ) -> _DDLE: ...
    def __call__(self, target: SchemaItem, bind: _Bind, **kw: Any) -> Optional[Any]: ...
...
class CreateSchema(_CreateDropBase):
    __visit_name__: str = ...
    quote: Any = ...
    def __init__(self, name: str, quote: Optional[Any] = ..., **kw: Any) -> None: ...
