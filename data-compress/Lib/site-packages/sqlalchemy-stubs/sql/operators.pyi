...
class Operators(Generic[_CE]):
    ...
    def bool_op(self, opstring: Any, precedence: int = ...) -> Callable[[Any], _CE]: ...
...
class ColumnOperators(Operators[ColumnElement[_TE]], Generic[_TE]):
    ...
    def is_distinct_from(self, other: Any) -> ColumnElement[sqltypes.Boolean]: ...
    def is_not_distinct_from(self, other: Any) -> ColumnElement[sqltypes.Boolean]: ...
    ...
    def match(self, other: Any, **kwargs: Any) -> ColumnElement[sqltypes.Boolean]: ...
    def regexp_match(
...
def not_like_op(a: Any, b: Any, escape: Optional[Any] = ...) -> ClauseElement: ...
def ilike_op(a: Any, b: Any, escape: Optional[Any] = ...) -> ClauseElement: ...
def not_ilike_op(a: Any, b: Any, escape: Optional[Any] = ...) -> ClauseElement: ...
def between_op(a: Any, b: Any, c: Any, symmetric: bool = ...) -> ClauseElement: ...
def not_between_op(a: Any, b: Any, c: Any, symmetric: bool = ...) -> ClauseElement: ...
...
def regexp_match_op(a: Any, b: Any, flags: Optional[Any] = ...) -> ClauseElement: ...
