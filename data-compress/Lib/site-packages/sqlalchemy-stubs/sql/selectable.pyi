...
class HasHints:
    def with_statement_hint(self: _HH, text: Any, dialect_name: str = ...) -> _HH: ...
    def with_hint(
...
class FromClause(roles.AnonymizedFromClauseRole, Selectable):
    ...
    schema: Any = ...
    is_selectable: bool = ...
    def select(self, whereclause: Optional[Any] = ..., **kwargs: Any) -> Select: ...
    def join(
        self,
        right: FromClause,
...
class Lateral(AliasedReturnsRows):
    ...
    inherit_cache: bool = ...
    @classmethod
    def _factory(cls, selectable: Selectable, name: Optional[str] = ...) -> Lateral: ...
...
class TableClause(roles.DMLTableRole, Immutable, FromClause):
    ...
    def delete(self, whereclause: Optional[Any] = ..., **kwargs: Any) -> dml.Delete: ...
...
class SelectBase(
    ...
    def alias(self, name: Optional[Any] = ..., flat: bool = ...) -> Subquery: ...
...
class CompoundSelect(HasCompileState, GenerativeSelect):
    ...
    @classmethod
    def _create_union_all(cls, *selects: Any, **kwargs: Any) -> CompoundSelect: ...
    @classmethod
    def _create_except(cls, *selects: Any, **kwargs: Any) -> CompoundSelect: ...
    @classmethod
    def _create_except_all(cls, *selects: Any, **kwargs: Any) -> CompoundSelect: ...
    @classmethod
    def _create_intersect(cls, *selects: Any, **kwargs: Any) -> CompoundSelect: ...
    @classmethod
    def _create_intersect_all(cls, *selects: Any, **kwargs: Any) -> CompoundSelect: ...
    def self_group(self, against: Optional[Any] = ...) -> SelectStatementGrouping: ...
...
class SelectState(util.MemoizedSlots, CompileState):
    ...
    @classmethod
    def from_statement(cls, statement: Any, from_statement: Any) -> NoReturn: ...
    @classmethod
