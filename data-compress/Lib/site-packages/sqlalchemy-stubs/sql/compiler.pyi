...
class Compiled:
    ...
    def visit_unsupported_compilation(self, element: Any, err: Any) -> _VisitResult: ...
    @property
...
class SQLCompiler(Compiled):
    ...
    def visit_lambda_element(self, element: Any, **kw: Any) -> _VisitResult: ...
    def visit_column(
        self,
        column: Any,
        add_to_result_map: Optional[Any] = ...,
    ...
    def visit_fromclause(self, fromclause: Any, **kwargs: Any) -> _VisitResult: ...
    ...
    def visit_type_coerce(self, type_coerce: Any, **kw: Any) -> _VisitResult: ...
    def visit_cast(self, cast: Any, **kwargs: Any) -> _VisitResult: ...
    def visit_over(self, over: Any, **kwargs: Any) -> _VisitResult: ...
    def visit_withingroup(self, withingroup: Any, **kwargs: Any) -> _VisitResult: ...
    def visit_funcfilter(self, funcfilter: Any, **kwargs: Any) -> _VisitResult: ...
    def visit_extract(self, extract: Any, **kwargs: Any) -> _VisitResult: ...
    def visit_scalar_function_column(self, element: Any, **kw: Any) -> _VisitResult: ...
    def visit_function(
        self, func: Any, add_to_result_map: Optional[Any] = ..., **kwargs: Any
    ) -> _VisitResult: ...
    def visit_next_value_func(self, next_value: Any, **kw: Any) -> _VisitResult: ...
    ...
    def visit_table_valued_alias(self, element: Any, **kw: Any) -> _VisitResult: ...
    def visit_table_valued_column(self, element: Any, **kw: Any) -> _VisitResult: ...
    def visit_alias(
        self,
        alias: Any,
        asfrom: bool = ...,
    ...
    def get_render_as_alias_suffix(self, alias_name_text: Any) -> _VisitResult: ...
    ...
    def get_select_precolumns(self, select: Any, **kw: Any) -> _VisitResult: ...
    ...
    def returning_clause(self, stmt: Any, returning_cols: Any) -> _VisitResult: ...
    ...
    def visit_rollback_to_savepoint(self, savepoint_stmt: Any) -> _VisitResult: ...
...
class DDLCompiler(Compiled):
    ...
    def visit_set_table_comment(self, create: Any, **kw: Any) -> _VisitResult: ...
    def visit_drop_table_comment(self, drop: Any, **kw: Any) -> _VisitResult: ...
    def visit_set_column_comment(self, create: Any, **kw: Any) -> _VisitResult: ...
    def visit_drop_column_comment(self, drop: Any, **kw: Any) -> _VisitResult: ...
    ...
    def get_column_specification(self, column: Any, **kwargs: Any) -> _VisitResult: ...
    ...
    def visit_check_constraint(self, constraint: Any, **kw: Any) -> _VisitResult: ...
    ...
    def visit_unique_constraint(self, constraint: Any, **kw: Any) -> _VisitResult: ...
    def define_constraint_cascades(self, constraint: Any) -> _VisitResult: ...
    def define_constraint_deferrability(self, constraint: Any) -> _VisitResult: ...
    def define_constraint_match(self, constraint: Any) -> _VisitResult: ...
    def visit_computed_column(self, generated: Any, **kw: Any) -> _VisitResult: ...
    def visit_identity_column(self, identity: Any, **kw: Any) -> _VisitResult: ...
...
class IdentifierPreparer:
    ...
    def quote_schema(self, schema: Any, force: Optional[Any] = ...) -> _VisitResult: ...
    def quote(self, ident: Any, force: Optional[Any] = ...) -> _VisitResult: ...
    def format_collation(self, collation_name: Any) -> _VisitResult: ...
    def format_sequence(
        self, sequence: Any, use_schema: bool = ...
    ) -> _VisitResult: ...
    def format_label(self, label: Any, name: Optional[Any] = ...) -> _VisitResult: ...
    def format_alias(self, alias: Any, name: Optional[Any] = ...) -> _VisitResult: ...
    ...
    def format_table_seq(self, table: Any, use_schema: bool = ...) -> _VisitResult: ...
