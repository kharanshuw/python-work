...
class _GetChildren(InternalTraversal):
    def visit_has_cache_key(self, element: Any, **kw: Any) -> Tuple[Any, ...]: ...
    ...
    def visit_clauseelement_unordered_set(self, element: _CE, **kw: Any) -> _CE: ...
    def visit_setup_join_tuple(
    ...
    def visit_dml_multi_values(self, element: Any, **kw: Any) -> Tuple[Any, ...]: ...
    def visit_propagate_attrs(self, element: Any, **kw: Any) -> Tuple[Any, ...]: ...
...
class TraversalComparatorStrategy(InternalTraversal, util.MemoizedSlots):
    ...
    def compare_bindparam(self, left: Any, right: Any, **kw: Any) -> List[str]: ...
