...
class DefaultGenerator(SchemaItem):
    ...
    def execute(self, bind: Optional[Union[Engine, Connection]] = ...) -> Any: ...
    @property
    def bind(self) -> Optional[Union[Engine, Connection]]: ...
...
class ColumnCollectionMixin:
    ...
    def __init__(self, *columns: Union[str, Column[Any]], **kw: Any) -> None: ...

class ColumnCollectionConstraint(ColumnCollectionMixin, Constraint):
    def __init__(self, *columns: Union[str, Column[Any]], **kw: Any) -> None: ...
    def __contains__(self, x: Any) -> bool: ...
    def copy(self: _CCC, target_table: Optional[Table] = ..., **kw: Any) -> _CCC: ...
...
class CheckConstraint(ColumnCollectionConstraint):
    ...
    def copy(self: _CC, target_table: Optional[Table] = ..., **kw: Any) -> _CC: ...
...
class Computed(FetchedValue, SchemaItem):
    ...
    def copy(self: _CP, target_table: Optional[Table] = ..., **kw: Any) -> _CP: ...
