...
def register_function(identifier: str, fn: Any, package: str = ...) -> None: ...
...
class FunctionElement(  # type: ignore[misc]
    ...
    @overload
    def filter(self, __criteria: Any, *criterion: Any) -> FunctionFilter[_TE]: ...
...
class OrderedSetAgg(GenericFunction[_TE]):
    ...
    inherit_cache: bool = ...
    def within_group_type(self, within_group: Any) -> type_api.TypeEngine[Any]: ...
