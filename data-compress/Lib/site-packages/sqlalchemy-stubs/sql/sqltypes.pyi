...
class String(Concatenable[str], TypeEngine[str]):  # type: ignore[misc]
    ...
    def literal_processor(self, dialect: Dialect) -> _LiteralProcessor[str]: ...
    def bind_processor(self, dialect: Dialect) -> Optional[_BindProcessor[str]]: ...
...
class Integer(_LookupExpressionAdapter[int], TypeEngine[int]):  # type: ignore[misc]
    ...
    def literal_processor(self, dialect: Dialect) -> _LiteralProcessor[int]: ...
...
class Boolean(Emulated, TypeEngine[bool], SchemaType):  # type: ignore[misc]
    ...
    def literal_processor(self, dialect: Dialect) -> _LiteralProcessor[bool]: ...
...
class JSON(
    ...
    class Comparator(Indexable.Comparator["JSON"], Concatenable.Comparator["JSON"]):
    ...
    def bind_processor(self, dialect: Dialect) -> _BindProcessor[_JSONType]: ...
    def result_processor(
        self, dialect: Dialect, coltype: Any
...
class NullType(TypeEngine[None]):
    hashable: bool = ...
    def literal_processor(self, dialect: Dialect) -> _LiteralProcessor[None]: ...
