...
class CompileState:
    plugins: Any = ...
    @classmethod
    def create_for_statement(cls, statement: Any, compiler: Any, **kw: Any) -> Any: ...
    statement: Any = ...
    def __init__(self, statement: Any, compiler: Any, **kw: Any) -> None: ...
    @classmethod
    def get_plugin_class(cls, statement: Any) -> Optional[Any]: ...
    @classmethod
    def plugin_for(cls, plugin_name: Any, visit_name: Any) -> Callable[[_T], _T]: ...
...
class ColumnCollection(Generic[_CE]):
    def __init__(self, columns: Optional[Iterable[Tuple[str, _CE]]] = ...) -> None: ...
...
class ImmutableColumnCollection(util.ImmutableContainer, ColumnCollection[_CE]):
